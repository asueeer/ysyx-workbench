...
void nvboard_bind_all_pins(Vtop* top){
	...
	nvboard_bind_pin(&top->sw, false, false, 8, SW7, SW6, SW5, SW4, SW3, SW2, SW1, SW0);
	...
	nvboard_bind_pin(&top->seg3, false, true, 8, SEG3A, SEG3B, SEG3C, SEG3D, SEG3E, SEG3F, SEG3G, DEC3P);
	nvboard_bind_pin(&top->seg4, false, true, 8, SEG4A, SEG4B, SEG4C, SEG4D, SEG4E, SEG4F, SEG4G, DEC4P);
	nvboard_bind_pin(&top->seg5, false, true, 8, SEG5A, SEG5B, SEG5C, SEG5D, SEG5E, SEG5F, SEG5G, DEC5P);
	nvboard_bind_pin(&top->seg6, false, true, 8, SEG6A, SEG6B, SEG6C, SEG6D, SEG6E, SEG6F, SEG6G, DEC6P);
	nvboard_bind_pin(&top->seg7, false, true, 8, SEG7A, SEG7B, SEG7C, SEG7D, SEG7E, SEG7F, SEG7G, DEC7P);
